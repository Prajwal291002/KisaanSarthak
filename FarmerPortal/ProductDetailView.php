...
<style>
    ...
    .cateo {
     ...
     .tab{
        ...
        <tr >
            <td class="cateo" align="center"><b>1. Product Cateogory : Eggs <br></b></td>
        </tr>
        <br>
        <tr id="producttype">
            <td align="center"><b>2. Product Type : Eggs <br></b></td>
        </tr>
        <br>
        <tr >
            <td align="center"><b>3. Product Stock : 5 dozen <br></b></td>
        </tr>
        <br>
        <tr >
            <td align="center"><b>4. Product Price : 70Rs/dozen <br></b></td>
        </tr>
        <br>
        <tr >fffffffffffffff
            <td align="center"><b>5. Product Description : Fresh eggs <br></b></td>
        </tr>
        <br>
        <tr >
            <td align="center"><b>6. Product Keyword : Eggs <br></b></td>
        </tr>
        <br>
        <tr >
