...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="input-group mb-1 ml-2 searchbox">
                ...
                <form action="SearchResult.php" method="get" enctype="multipart/form-data">
                    <input type="text" class="form-control " id="inlineFormInputGroup" name="search" placeholder=" " style="width:500px;">
                </form>
            </div>
            <?php
            getUsername();
    ...
    <div class="container"> <img src="welcomef.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 id="headings" class="guard"><span><b>Meat</b></span>
            </h1>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Fresh fruits</h2> -->
            <h1 id="headings" class="guard"><span><b>Eggs </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>Best sellers </b></span>
            </h1>
        </div>
        <br>
        <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agrocraft.com/">KisaanSardhak</a></u> is a Multitrading Porta; for farmers an traders</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">KisaanSardhak</a></p>
                </div>
                </hr>
            </div>
        </div>
